...
{
    /// <summary>
    /// Converts a <see cref="DateTime"/> value to an <see cref="Instant"/> value.
    /// </summary>
    public class InstantConverter : JsonConverter<Instant>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstantConverter"/> class with no arguments.
        /// </summary>
        ...
        {
            return typeof(Instant).Equals(type) || typeof(DateTime).Equals(type);
        }

        /// <summary>
        /// Writes the <see cref="Instant"/> value to <paramref name="writer"/>.
        /// </summary>
