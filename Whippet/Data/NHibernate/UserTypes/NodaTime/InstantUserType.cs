...
{
    /// <summary>
    /// Represents the custom <see cref="IUserType"/> for <see cref="Instant"/>.
    /// </summary>
    public class InstantUserType : WhippetUserTypeBase, IUserType
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstantUserType"/> class with no arguments.
        /// </summary>
        public InstantUserType()
            : base()
        {
            SqlTypes = new[] { SqlTypeFactory.DateTime };
            ReturnedType = typeof(Instant);
            IsMutable = false;
        }
        ...
        public override object NullSafeGet(DbDataReader rs, string[] names, ISessionImplementor session, object owner)
        {
            ...
            //return (rawObj == null) ? null : Instant.FromDateTimeUtc((DateTime)(rawObj));
            return rawObj;
        }
