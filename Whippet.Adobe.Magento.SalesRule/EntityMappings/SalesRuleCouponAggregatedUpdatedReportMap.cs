...
{
    /// <summary>
    /// Provides a Fluent mapping for <see cref="SalesRuleCouponAggregatedUpdatedReportMap"/> objects.
    /// </summary>
    public class SalesRuleCouponAggregatedUpdatedReportMap : MagentoFluentMap<SalesRuleCouponAggregatedReport>
    {
        private const string TABLE_NAME = "salesrule_coupon_aggregated_updated";

        /// <summary>
        /// Initializes a new instance of the <see cref="SalesRuleCouponAggregatedUpdatedReportMap"/> class with no arguments.
        /// </summary>
        public SalesRuleCouponAggregatedUpdatedReportMap()
            : base(TABLE_NAME)
        {
