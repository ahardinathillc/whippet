...
namespace Athi.Whippet.Adobe.Magento.SalesRule
{
    ...
    /// </summary>
    public class SalesRuleCouponAggregatedReport : MagentoEntity, IMagentoEntity, ISalesRuleCouponAggregatedReport, IEqualityComparer<ISalesRuleCouponAggregatedReport>
    {
        private Store _store;

        /// <summary>
        /// Gets or sets the unique ID of the <see cref="SalesRuleCouponAggregatedReport"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesRuleCouponAggregatedReport"/> class with no arguments.
        /// </summary>
        public SalesRuleCouponAggregatedReport()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="SalesRuleCouponAggregatedReport"/> class with the specified rule ID and <see cref="MagentoServer"/>.
        /// </summary>
        /// <param name="ruleId">Rule ID.</param>
        /// <param name="server"><see cref="MagentoServer"/> the entity resides on.</param>
        public SalesRuleCouponAggregatedReport(uint ruleId, MagentoServer server)
            : base(ruleId, server)
        { }
        ...
        {
            return (obj == null || !(obj is ISalesRuleCouponAggregatedReport)) ? false : Equals(obj as ISalesRuleCouponAggregatedReport);
        }
