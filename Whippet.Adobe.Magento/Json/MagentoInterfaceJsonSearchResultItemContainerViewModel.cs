...
namespace Athi.Whippet.Adobe.Magento.Json
{
    ...
    internal sealed class MagentoInterfaceJsonSearchResultItemContainerViewModel<T> : IMagentoInterfaceJsonSearchResultItemContainerViewModel<T> where T : IExtensionInterface, new()
    {
        ...
        /// </summary>
        IMagentoJsonSearchCriteriaViewModel IMagentoInterfaceJsonSearchResultItemContainerViewModel<T>.SearchCriteria
        {
            get
            {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MagentoInterfaceJsonSearchResultItemContainerViewModel{T}"/> class with no arguments.
        /// </summary>
        public MagentoInterfaceJsonSearchResultItemContainerViewModel()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="MagentoInterfaceJsonSearchResultItemContainerViewModel{T}"/> class with the specified parameters.
        /// </summary>
        ...
        public MagentoInterfaceJsonSearchResultItemContainerViewModel(IEnumerable<T> items, MagentoJsonSearchCriteriaViewModel searchCriteria, int totalCount)
            : this()
        {
            Items = items;
