...
namespace Athi.Whippet.Adobe.Magento.Carts.GuestCarts
{
    ...
    /// </summary>
    public class GuestCartTotalsInterface : IExtensionInterface, IExtensionAttributes<CartTotalsExtensionInterface>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GuestCartTotalsInterface"/> class with no arguments.
        /// </summary>
        public GuestCartTotalsInterface()
        { }
    }
}
