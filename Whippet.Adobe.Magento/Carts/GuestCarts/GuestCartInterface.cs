...
{
    /// <summary>
    /// Interface that provides information about a guest customer's cart in Magento.
    /// </summary>
    public class GuestCartInterface : IExtensionInterface, IExtensionAttributes<CartExtensionInterface>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GuestCartInterface"/> class with no arguments.
        /// </summary>
        public GuestCartInterface()
        { }
    }
}
