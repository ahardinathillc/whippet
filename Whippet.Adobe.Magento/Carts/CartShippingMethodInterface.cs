...
namespace Athi.Whippet.Adobe.Magento.Carts
{
    ...
    /// </summary>
    public class CartShippingMethodInterface : IExtensionInterface, IExtensionAttributes<CartShippingMethodExtensionInterface>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CartShippingMethodInterface"/> class with no arguments.
        /// </summary>
        public CartShippingMethodInterface()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="CartShippingMethodInterface"/> class with the specified parameters.
        /// </summary>
        ...
        public CartShippingMethodInterface(string carrierCode, string methodCode, string carrier, string method, decimal amount, decimal amountBase, bool available, CartShippingMethodExtensionInterface extensionAttributes, string errorMessage, decimal priceExcludingTax)
            : this()
        {
