...
namespace Athi.Whippet.FreestyleSolutions.MultichannelOrderManager.ServiceManagers.Queries
{
    ...
    /// </summary>
    public sealed class GetMultichannelOrderManagerSuppliersQuery : WhippetQuery<MultichannelOrderManagerSupplier>, IWhippetQuery<MultichannelOrderManagerSupplier>
    {
        /// <summary>
