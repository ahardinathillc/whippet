...
using Athi.Whippet.Logging.Serilog;

namespace Athi.Whippet.Data.NHibernate.UserTypes
{
    /// <summary>
    /// Represents the custom <see cref="IUserType"/> for <see cref="SerilogLevel"/>.
    /// </summary>
    public class SerilogLevelUserType : WhippetUserTypeBase, IUserType
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SerilogLevelUserType"/> class with no arguments.
        /// </summary>
        public SerilogLevelUserType()
            : base()
        {
            SqlTypes = new[] { SqlTypeFactory.GetString(Int32.MaxValue) };
            ReturnedType = typeof(SerilogLevel);
            IsMutable = false;
        }
        ...
        public override object NullSafeGet(DbDataReader rs, string[] names, ISessionImplementor session, object owner)
        {
            ...
            SerilogLevel enumValue = default(SerilogLevel);
            ...
            if (rawObj != null)
            {
                if (Enum.TryParse(typeof(SerilogLevel), Convert.ToString(rawObj), out rawEnumValue))
                {
                    enumValue = (SerilogLevel)(rawEnumValue);
                }
