...
{
    /// <summary>
    /// Command handler for <see cref="CreateWhippetUserTenantAssignmentCommand"/> objects.
    /// </summary>
    public class CreateWhippetUserTenantAssignmentCommandHandler : WhippetUserTenantAssignmentCommandHandlerBase<CreateWhippetUserTenantAssignmentCommand>
    {
        /// <summary>
        ...
        public CreateWhippetUserTenantAssignmentCommandHandler(IWhippetUserTenantAssignmentRepository repository)
            : base(repository)
        { }
        ...
        /// <exception cref="ArgumentNullException" />
        public override async Task<WhippetResult> HandleAsync(CreateWhippetUserTenantAssignmentCommand command)
        {
            if (command == null)
            {
            ...
            else
            {
                ...
                if (result.IsSuccess)
                {
                    result = await Repository.CreateAsync(command.Assignment);
                }
