...
{
    /// <summary>
    /// Command handler for <see cref="UpdateWhippetTenantCommand"/> objects.
    /// </summary>
    public class UpdateWhippetTenantCommandHandler : WhippetTenantCommandHandlerBase<UpdateWhippetTenantCommand>
    {
        /// <summary>
        ...
        public UpdateWhippetTenantCommandHandler(IWhippetTenantRepository repository)
            : base(repository)
        { }
        ...
        /// <exception cref="ArgumentNullException" />
        public override async Task<WhippetResult> HandleAsync(UpdateWhippetTenantCommand command)
        {
            if (command == null)
            {
            ...
            else
            {
                ...
                if (result.IsSuccess)
                {
                    result = await Repository.UpdateAsync(command.Tenant);
                }
