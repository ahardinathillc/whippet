...
namespace Athi.Whippet.FreestyleSolutions.MultichannelOrderManager
{
    ...
    /// </summary>
    public class MultichannelOrderManagerCustomerType__Three : MultichannelOrderManagerEntity, IWhippetEntity, IWhippetEntityExternalDataRowImportMapper, IMultichannelOrderManagerCustomerType__Three, IEqualityComparer<IMultichannelOrderManagerCustomerType__Three>, IMultichannelOrderManagerEntity
    {
        ...
        /// <summary>
        /// Gets or sets the parent <see cref="IMultichannelOrderManagerServer"/> object that the <see cref="IMultichannelOrderManagerCustomerType__Three"/> is registered with.
        /// </summary>
        ...
        protected override string ExternalTableName
        {
            get
            {
                return MultichannelOrderManagerDatabaseConstants.Tables.CTYPE3;
            }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultichannelOrderManagerCustomerType__Three"/> class with no arguments.
        /// </summary>
        public MultichannelOrderManagerCustomerType__Three()
            : base()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="MultichannelOrderManagerCustomerType__Three"/> with the specified ID.
        /// </summary>
        /// <param name="id">Unique ID of the entity.</param>
        public MultichannelOrderManagerCustomerType__Three(Guid id)
            : base(id)
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="MultichannelOrderManagerCustomerType__Three"/> with the specified parameters.
        /// </summary>
        /// <param name="id">Unique ID of the entity.</param>
        ...
        public MultichannelOrderManagerCustomerType__Three(Guid id, string customerType, string description, long typeId)
            : this(id)
        {
        ...
        {
            WhippetDataRowImportMapEntry ctype = new WhippetDataRowImportMapEntry(nameof(CustomerType), MultichannelOrderManagerDatabaseConstants.Columns.CTYPE3);
            ...
            WhippetDataRowImportMapEntry ctypeId = new WhippetDataRowImportMapEntry(nameof(TypeId), MultichannelOrderManagerDatabaseConstants.Columns.CTYPE3_ID);
        ...
        public override DataTable CreateDataTable()
        {
            ...
            DataColumn ctype = DataColumnFactory.CreateDataColumn(map[nameof(CustomerType)].Column, typeof(char), false, 2);
        ...
        {
            return Equals(obj as IMultichannelOrderManagerCustomerType__Three);
        }
        ...
        /// <param name="obj">The object to compare with the current object.</param>
        /// <returns><see langword="true"/> if the specified object is equal to the current object; otherwise, <see langword="false"/>.</returns>
        public virtual bool Equals(IMultichannelOrderManagerCustomerType__Three obj)
        {
        ...
        /// </summary>
        /// <param name="a">The first object of type <see cref="IMultichannelOrderManagerCustomerType__Three"/> to compare.</param>
        /// <param name="b">The second object of type <see cref="IMultichannelOrderManagerCustomerType__Three"/> to compare.</param>
        /// <returns><see langword="true"/> if the specified objects are equal; otherwise, <see langword="false"/>.</returns>
        public virtual bool Equals(IMultichannelOrderManagerCustomerType__Three a, IMultichannelOrderManagerCustomerType__Three b)
        {
        ...
        /// <exception cref="ArgumentNullException" />
        public virtual int GetHashCode(IMultichannelOrderManagerCustomerType__Three obj)
        {
            if (obj == null)
            {
