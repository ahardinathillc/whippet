...
namespace Athi.Whippet.FreestyleSolutions.MultichannelOrderManager
{
    ...
    /// </summary>
    public interface IMultichannelOrderManagerStateProvince : IWhippetEntity, IWhippetEntityExternalDataRowImportMapper, IEqualityComparer<IMultichannelOrderManagerStateProvince>, IMultichannelOrderManagerEntity, IWhippetEntityDynamicImportMapper, IWhippetCloneable, IComparable<IMultichannelOrderManagerStateProvince>
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the warehouse that serves the state/province.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether to tax handling fees only for national tax rates.
        /// </summary>
        bool TaxHandlingFeesNationalTaxRateOnly
        { get; set; }
