...
{
    /// <summary>
    /// Command handler for <see cref="CreateCityCommand"/> objects.
    /// </summary>
    public class CreateCityCommandHandler : CityCommandHandlerBase<CreateCityCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCityCommandHandler"/> class with the specified <see cref="ICityRepository"/> object.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException" />
        public override async Task<WhippetResult> HandleAsync(CreateCityCommand command)
        {
            if (command == null)
            {
            ...
            else
            {
                ...
                if (result.IsSuccess)
                {
                    result = await Repository.CreateAsync(command.City);
                }
