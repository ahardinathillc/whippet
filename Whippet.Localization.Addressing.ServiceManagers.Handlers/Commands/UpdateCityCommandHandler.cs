...
{
    /// <summary>
    /// Command handler for <see cref="UpdateCityCommand"/> objects.
    /// </summary>
    public class UpdateCityCommandHandler : CityCommandHandlerBase<UpdateCityCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCityCommandHandler"/> class with the specified <see cref="ICityRepository"/> object.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException" />
        public override async Task<WhippetResult> HandleAsync(UpdateCityCommand command)
        {
            if (command == null)
            {
            ...
            else
            {
                ...
                if (result.IsSuccess)
                {
                    result = await Repository.UpdateAsync(command.City);
                }
