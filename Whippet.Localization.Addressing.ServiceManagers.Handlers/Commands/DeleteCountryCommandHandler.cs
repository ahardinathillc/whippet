...
{
    /// <summary>
    /// Command handler for <see cref="DeleteCountryCommand"/> objects.
    /// </summary>
    public class DeleteCountryCommandHandler : CountryCommandHandlerBase<DeleteCountryCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCountryCommandHandler"/> class with the specified <see cref="ICountryRepository"/> object.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException" />
        public override async Task<WhippetResult> HandleAsync(DeleteCountryCommand command)
        {
            if (command == null)
            {
            ...
            else
            {
                ...
                if (result.IsSuccess)
                {
                    result = await Repository.DeleteAsync(command.Country);
                }
