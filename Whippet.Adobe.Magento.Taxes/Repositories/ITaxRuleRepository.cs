...
namespace Athi.Whippet.Adobe.Magento.Taxes.Repositories
{
    ...
    /// </summary>
    public interface ITaxRuleRepository : IWhippetRepository<TaxRule, int>, IWhippetExternalQueryRepository<TaxRule, int>, IMagentoBulkSupport<TaxRule>, IMagentoEntityRepository<TaxRule>
    { }
}
