...
namespace Athi.Whippet.Data.Database.Microsoft
{
    ...
    /// </summary>
    public sealed class WhippetSqlServerTransaction : DbTransaction, IDisposable
    {
        /// <summary>
        /// Gets or sets the internal <see cref="SqlTransaction"/> object.
        /// </summary>
        private SqlTransaction InternalTransaction
        { get; set; }

        /// <summary>
        /// Gets the <see cref="WhippetSqlServerConnection"/> object associated with the transaction or <see langword="null"/> if the transaction is no longer valid. This property is read-only.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhippetSqlServerTransaction"/> class with the specified <see cref="SqlTransaction"/> object.
        /// </summary>
        /// <param name="transaction"><see cref="SqlTransaction"/> object to initialize with.</param>
        /// <exception cref="ArgumentNullException" />
        public WhippetSqlServerTransaction(SqlTransaction transaction)
        {
            if (transaction == null)
            {
        ...
        public static implicit operator WhippetSqlServerTransaction(SqlTransaction transaction)
        {
            return (transaction == null) ? null : new WhippetSqlServerTransaction(transaction);
        }

        public static implicit operator SqlTransaction(WhippetSqlServerTransaction transaction)
        {
